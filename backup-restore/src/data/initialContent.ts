  ...
  reviews: [
    {
      ...
      country: 'Portugal',
      rating: 5,
      text: 'Reserve já as suas férias',
      text_en: 'Book your holidays now',
      text_fr: 'Réservez déjà vos vacances',
      text_de: 'Buchen Sie jetzt Ihren Urlaub',
      apartment: 'Penthouse',
      date: '2024-08',
      active: true,
    },
    {
      ...
      country: 'Portugal',
      rating: 5,
      text: 'Pronto para as suas férias de sonho?',
      text_en: 'Ready for your dream holidays?',
      text_fr: 'Prêt pour vos vacances de rêve?',
      text_de: 'Bereit für Ihren Traumurlaub?',
      apartment: 'Prestige',
      date: '2024-07',
      active: true,
    },
    {
      ...
      country: 'Portugal',
      rating: 5,
      text: 'Reserve já o seu apartamento em Albufeira e desfrute do melhor do Algarve.',
      text_en: 'Book your apartment in Albufeira now and enjoy the best of the Algarve.',
      text_fr: 'Réservez votre appartement à Albufeira dès maintenant et profitez du meilleur de l\'Algarve.',
      text_de: 'Buchen Sie jetzt Ihre Wohnung in Albufeira und genießen Sie das Beste der Algarve.',
      apartment: 'Duplex',
      date: '2024-09',
      active: true,
    },
